...
export class NewTournamentNameDialogComponent
  extends BaseDialogComponent
  implements OnInit
{
  form: FormGroup;
  public tournamentNameFc: FormControl = new FormControl("", [
    Validators.required,
  ]);

  constructor(
    public dialogRef: MatDialogRef<NewTournamentNameDialogComponent>,
    @Inject(MAT_DIALOG_DATA) { tournamentNameFc },
