...
export class NewWeightClassDialogComponent
  extends BaseDialogComponent
  implements OnInit
{
  form: FormGroup;
  public weightClassNameFc: FormControl = new FormControl("", [
    Validators.required,
  ]);

  constructor(
    public dialogRef: MatDialogRef<NewWeightClassDialogComponent>,
    @Inject(MAT_DIALOG_DATA) { weightClassNameFc },
