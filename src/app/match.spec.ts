...
describe ('tests for the match class', ()=>{
  it('can create a match', ()=>{
    let matchDeets: VideoDetails = new VideoDetails("worlds", "california", new Date().toJSON(), "athlete1", "athlete2", "rooster", "black belt", "https://www.youtube.com/watch?v=LPj368_plK0&index=183&list=WL", "male", false, "master 1");
