export class VideoDetails {
  public annotationRating: number;
  public videoRating: number;
  public flaggedAsMissing: boolean;
  public flaggedAsInappropriate: boolean;
  public tournamentName: string;
  public location: string;
  public date: string;
  public athlete1Name: string;
  public athlete2Name: string;
  public weightClass: string;
  public rank: string;
  public gender: string;
  public giStatus: boolean;
  ...
  static fromForm(deetObj: any): VideoDetails {
    ...
    videoDeetReturnObj["tournamentName"] = tournamentNameBound
      ? tournamentNameBound
      : "";
    videoDeetReturnObj["location"] = locationBound ? locationBound : "";
    videoDeetReturnObj["date"] = tournamentDateBound ? tournamentDateBound : "";
    videoDeetReturnObj["athlete1Name"] = athlete1NameBound
      ? athlete1NameBound
      : "";
    videoDeetReturnObj["athlete2Name"] = athlete2NameBound
      ? athlete2NameBound
      : "";
    ...
    videoDeetReturnObj["genericArgs"] = genericArgsBound
      ? genericArgsBound
      : {};
    if (videoUrlBound) {
