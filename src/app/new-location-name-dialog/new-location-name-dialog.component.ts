...
export class NewLocationNameDialogComponent
  extends BaseDialogComponent
  implements OnInit
{
  form: FormGroup;
  public locationNameFc: FormControl = new FormControl("", [
    Validators.required,
  ]);

  constructor(
    public dialogRef: MatDialogRef<NewLocationNameDialogComponent>,
    @Inject(MAT_DIALOG_DATA) { locationNameFc },
