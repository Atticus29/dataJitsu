...
export class QuestionService {
  ...
  private confirmPasswordQuestion: PasswordTextQuestion =
  ...
  private gymAffiliationQuestion: AutocompleteQuestion =
  ...
  private passwordTextTestQuestion: PasswordTextQuestion =
    new PasswordTextQuestion({
      key: "passwordUpdate",
      label: "Password",
      value: "",
  ...
  private weightClassEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  private tournamentNameEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  private individualOneEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  private individualTwoEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  private testIndividualOneEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
      key: "individualOneUpdate",
      label: "Individual 1 Name",
      value: "",
  ...
  private testIndividualTwoEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
      key: "individualTwoUpdate",
      label: "Individual 2 Name",
      value: "",
  ...
  private testSlideToggleQuestion: SlideToggleQuestion =
