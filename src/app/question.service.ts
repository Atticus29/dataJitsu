...
export class QuestionService {
  ...
  public userNameQuestion: TextQuestion = new TextQuestion({
    key: "name",
    label: "User Name",
    value: "",
    required: true,
  ...
  public emailAddressQuestion: TextQuestion = new TextQuestion({
    key: "email",
    label: "Email Address",
    value: "",
    required: true,
  ...
  public passwordQuestion: PasswordTextQuestion = new PasswordTextQuestion({
    key: "password",
    label: "Password",
    value: "",
    required: true,
  ...
  public confirmPasswordQuestion: PasswordTextQuestion =
    new PasswordTextQuestion({
      key: "confirmPassword",
  ...
  public gymAffiliationQuestion: AutocompleteQuestion =
  ...
  public genderQuestion: DropdownQuestion = new DropdownQuestion({
    key: "gender",
    label: "Choose Gender",
    value: "",
    required: false,
  ...
  public giRankQuestion: AutocompleteQuestion = new AutocompleteQuestion({
    key: "giRank",
    label: "Gi Rank",
    value: "",
    required: false,
  ...
  public noGiRankQuestion: AutocompleteQuestion = new AutocompleteQuestion({
    key: "noGiRank",
    label: "No Gi Rank",
    value: "",
    required: false,
  ...
  public weightQuestion: TextQuestion = new TextQuestion({
    key: "weight",
    label: "Weight in kg",
    value: "",
    required: false,
  ...
  public ageQuestion: TextQuestion = new TextQuestion({
    key: "age",
    label: "Age",
    value: "",
    required: false,
  ...
  public passwordTextTestQuestion: PasswordTextQuestion =
    new PasswordTextQuestion({
      key: "passwordUpdate",
      label: "Password",
      value: "",
  ...
  public shamQuestion: TextQuestion = new TextQuestion({
    key: "",
    label: "",
    value: "",
    required: false,
  ...
  public ageClassEditQuestion: AutocompleteQuestion = new AutocompleteQuestion({
    key: "ageClassUpdate",
    label: "Age Class",
    value: "",
    required: false,
  ...
  public weightClassEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  public giNogiEditQuestion: SlideToggleQuestion = new SlideToggleQuestion({
    key: "giNogiUpdate",
    label: "Gi",
    secondLabel: "No Gi",
  ...
  public tournamentNameEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  public dateEditQuestion: DatePickerQuestion = new DatePickerQuestion({
    key: "dateUpdate",
    label: "Date",
    value: "",
    required: false,
  ...
  public locationEditQuestion: AutocompleteQuestion = new AutocompleteQuestion({
    key: "locationUpdate",
    label: "Location",
    value: "",
    required: false,
  ...
  public rankEditQuestion: AutocompleteQuestion = new AutocompleteQuestion({
    key: "rankUpdate",
    label: "Rank",
    value: "",
    required: false,
  ...
  public individualOneEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  public individualTwoEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
  ...
  public testIndividualOneEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
      key: "individualOneUpdate",
      label: "Individual 1 Name",
      value: "",
  ...
  public testIndividualTwoEditQuestion: AutocompleteQuestion =
    new AutocompleteQuestion({
      key: "individualTwoUpdate",
      label: "Individual 2 Name",
      value: "",
  ...
  // public userNameQuestion: TextQuestion = new TextQuestion({ //TODO create user questions here
  ...
  //   dropdownOptions: []
  // });
  public secondTestSlideToggle: SlideToggleQuestion = new SlideToggleQuestion({
  ...
  public testSlideToggleQuestion: SlideToggleQuestion = new SlideToggleQuestion(
    {
      key: "testSlideToggle",
      label: "Gay",
  ...
  public collectionNameQuestion: TextQuestion = new TextQuestion({
    key: "collectionName",
    ...
    indentThisQuestion: false,
    placeHolder:
      "E.g., Pyrenean Ibex Behavior Videos or Biology 101 Course Videos",
    type: "text",
    order: 1,
    submitAfterThisQuestion: false,
  });
  public categoryNameQuestion: TextQuestion = new TextQuestion({
    key: "categoryName",
    label: "Category Name",
    groupLabel: "Category",
    value: "",
  ...
  public collectionItemQuestion: TextQuestion = new TextQuestion({
    key: "itemName",
    label: "Item Name",
    value: "",
    required: false,
  ...
  public labelQuestion: TextQuestion = new TextQuestion({
    ...
    indentThisQuestion: false,
    placeHolder:
      "E.g., Video URL (note that this question is required and will be automatically generated)",
    type: "text",
    order: 1,
    submitAfterThisQuestion: false,
  });
  public genericLabelQuestion: TextQuestion = new TextQuestion({
  ...
  public inputTypeQuestion: DropdownQuestion = new DropdownQuestion({
    ...
    dropdownOptions: [
      ...
      { key: "datepicker", value: "Date Picker" },
      { key: "toggle", value: "Slide Toggle" },
      { key: "autocomplete", value: "Autocomplete" },
    ],
    submitAfterThisQuestion: true,
  });
  public genericInputTypeQuestion: DropdownQuestion = new DropdownQuestion({
    key: "inputTypeQuestionName",
    label: "What type of question do you want this question to be?",
    groupLabel: "Question For Your Users",
    value: "",
  ...
  public userNameAutocomplete: AutocompleteQuestion = new AutocompleteQuestion({
    key: "userDelete",
    label: "Select User",
    value: "",
    required: true,
    ...
    if (ownerQuestions) {
      ...
      for (let i = 0; i < ownerQuestions.length; i++) {
        ...
        const questionContent: any = {
          ...
          value: "",
          required:
            currentOwnerQuestion.question === "Video URL" ? true : false,
          giveOptionToAnswerThisQuestionMultipleTimes: false,
          disableAddButtonIfCurrentValueIsBlank: false,
          groupLabel: "Questions about the video",
          disableAddNewQuestionGroupButtonIfCurrentValueIsBlank: true,
          pairThisQuestionWithPreviousQuestion:
            currentOwnerQuestion.type === "Dropdown" ? true : false,
          isThisQuestionTheLastOfAQuestionGroup: false, //i<ownerQuestions.length-1 ? false:true,
          indentThisQuestion: false,
          placeHolder: "",
          smallSize: 12,
