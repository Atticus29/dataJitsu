...
export class HorizontalTimelineComponent implements AfterViewInit {
  ...
  public _viewInitialized = false;

  constructor(public _cdr: ChangeDetectorRef) {}

  public _timelineWrapperWidth = 720;
  ...
  public _eventsMinDistance: number = 80;
  ...
  public _timelineElements: TimelineElement[];
  ...
  public _dateFormat: string = "dd.MM.yyyy";
  ...
  public static pxToNumber(val: string): number {
    return Number(val.replace("px", ""));
  }

  public static getElementWidth(element: Element): number {
  ...
  public static parentElement(element: any, tagName: string) {
  ...
  public static getTranslateValue(timeline: Element) {
  ...
  public static setTransformValue(element: any, property: any, value: any) {
  ...
  public static timeDiff(first: number, second: number): number {
    return Math.round(second - first);
  }

  public static minLapse(elements: TimelineElement[]): number {
    ...
    for (let i = 1; i < elements.length; i++) {
      let distance = HorizontalTimelineComponent.timeDiff(
        elements[i - 1].startTime,
  ...
  setTimelineWidth(
    ...
    if (elements.length > 1) {
      timeSpan = HorizontalTimelineComponent.timeDiff(
        elements[0].startTime,
        elements[elements.length - 1].startTime
      );
    }
  ...
  public updateFilling(element: any) {
    // console.log("element");
    // console.log(element);
