...
export class TestDbComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.athleteNames = ["Tonon, Garry", "Gracie, Kron", "Garcia, Marcelo", "Ribeiro, Xande", "Oliveira, Arnaldo", "Cornelius, Kennan", "Lo, Leandro", "Musumeci, Michael", "Miyao, João", "Mendes, Rafael", "Charles, Rubens Cobrihna", "Santana, Murilo", "Barral, Romulo", "Ribeiro, Vitor 'Shaolin'",
...
"Gundlach, Andrew", "Candela, Austin", "Fisher, Mark"];
